...
public class BNCovid extends BNhan {
	...
	public void nhap() {
		...
		System.out.print("Nhập ngày cách li:");
		ngay = sc.nextLine();
		System.out.print("Nhập loại (là số F(0)=0, F(2)=2,F(3)=3,..):");
		loai = sc.nextLine().charAt(0);
		System.out.print("Nhập ổ dịch:");
		odich = sc.nextLine();
		System.out.print("Nhập nơi:");
		noi = sc.nextLine();
	}
...
//>>>>>>>>>>>>>>CAC BENH NHAN COVID TAI O DICH HOSIDEN<<<<<<<<<<<<<<<<<<<<
...
//>>>>>>>>>>>>>>CAC BENH NHAN HET CACH LI TRUOC NGAY 18-05-2021<<<<<<<<<<<<<<<<<<<<
