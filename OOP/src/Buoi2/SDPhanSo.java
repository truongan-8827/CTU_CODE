...
public class SDPhanSo {
	...
	public static void main(String[] args) {
		...
		PhanSo a=new PhanSo(3,7); a.hienThi();
		System.out.println("Tao phan so b");
		PhanSo b=new PhanSo(4,9); b.hienThi();
		...
		x.chuanhoaPhanSo(); y.chuanhoaPhanSo();
		System.out.println("x va y sau khi chuan hoa la"); x.hienThi(); y.hienThi();
